...
# On se place dans atelier-5/, là où sont les fichiers compose
cd "$(dirname "$0")/.."
# Le blue/green est dans docker-compose.deploy.yml (docker-compose.yml sert à la stack d'observabilité)
